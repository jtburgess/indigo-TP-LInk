...
#
#  Author George Georgovassilis, https://github.com/ggeorgovassilis/linuxscripts/blob/master/tp-link-hs100-smartplug/hs100.sh
#
# Also see: http://www.tp-link.us/products/details/HS100.html
...
show_usage() {
  ...
  echo
  echo e.g. $0 192.168.0.24 status
  exit 1
}
